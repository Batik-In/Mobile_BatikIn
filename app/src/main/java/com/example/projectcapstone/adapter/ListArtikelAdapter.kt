...
class ListArtikelAdapter(private val listArtikel: ArrayList<dummyartikeldata>, private val pref: UserPreference) : RecyclerView.Adapter<ListArtikelAdapter.ListViewHolder>() {
    ...
    fun fetchDataFromApi() {
        ...
        val url = URL("https://backend.batikin.site/api/articles?categoryId=1")
